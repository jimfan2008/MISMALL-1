 ...
 * @version $Id: Curl.class.php 2.0 2012-12-22 21:45:01Z tommy $
 * @package library
 * @since 1.0
 */
...
class Curl {
    ...
    public static function get($url, $data = array(), $proxy = null, $expire = 30) {
         return self::execute($url, $data, 'get', $proxy, $expire);
    }
    ...
    public static function post($url, $data = array(), $proxy = null, $expire = 30) {
        return self::execute($url, $data, 'post', $proxy, $expire);
    }
     ...
     * @return string
     */
    public static function execute($url, $data = array(), $method = '', $proxy = null, $expire = 30){
    	//参数分析
