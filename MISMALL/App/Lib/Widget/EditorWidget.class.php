...
/**
 * 编辑器
 * @example W('Editor',array('width'=>300,'height'=>'200','contentName'=>'mycontent','value'=>'默认的值','type'=>'base'))
 * @author jason
 * @version TS3.0
 */
class EditorWidget extends Widget{
	...
	public function render($data){
	    ...
	    $content = $this->renderFile(dirname(__FILE__).'/Editor/default.html',$var);
	    unset($var,$data);
	    // 输出数据
	    return $content;
  }
