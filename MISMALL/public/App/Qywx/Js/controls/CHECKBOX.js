...
define(function(require, exports, module) {
	...
	var ctrl = {
		...
		html : '<div class="row ctrl imFormCtrl" ctrl-type="CHECKBOX"><label class="control-label fieldTitle col-xs-3">选项框</label><div class="ctrlWraper col-xs-9 btnRadio"><label isbasectrl="true" class="checkbox-inline itemLabel buttonType" ><input type="checkbox"  isbasectrl="true" name="CCCheckBox8"> <span>选项1</span></label><label class="checkbox-inline itemLabel buttonType"><input type="checkbox"  isbasectrl="true" name="CCCheckBox8"><span>选项2</span></label><span style="display:none;" class="input-group-addon unit"></span><span class="help-block ctrlproInfo"></span></div><div class="ctrlValue"></div><div class = "formInputArrow">&gt;</div><div class = "ctrlIconWraper"></div></div>',
		cName : '选项框',
		attrs : {

			General : ["title", "proInfo", "isHidden"],
			//	Validate : ["qequired"],
			Item : ["addItem", "items", "checkNum"]
		},
		event : {
			click : {
				title : "单击",
