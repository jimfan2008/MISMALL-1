...
(function()
{
		...
		editor.ui.addRichCombo( comboName,
			{
				...
				onClick : function( value )
				{
					...
					editor.fire( 'saveSnapshot' );
					ezGlobal.Obj.find(".text").css("line-height",value);
	...
	CKEDITOR.plugins.add('lineheight',
	{
		...
		init : function( editor )
		{
		    var config = editor.config;
		    //当前选中的文本控件 
		    var textObj = $(".mk_current").find(".text");
		    var lineHeight = textObj ? textObj.css("line-height") : 19;
		    if(lineHeight){
		    	CKEDITOR.config.lineheight_defaultLabel = lineHeight;
		    }
 ...
 */
//CKEDITOR.config.lineheight_defaultLabel = '10px';


CKEDITOR.config.lineheight_sizes = 
	'10px;12px;13px;15px;17px;18px;19px;20px;22px;25px;30px;40px;50px';
