...
class ContentReplaceBehavior extends Behavior {
    ...
    protected function templateContentReplace($content) {
    	//TODO　定义网站域名，因IE及SAE上只能用全路径
    	//defined('__HTTP__HOST__') or define('__HTTP__HOST__', (is_ssl()?'https://':'http://').$_SERVER['HTTP_HOST']);
        // 系统默认的特殊变量替换
        $replace =  array(
        	...
        	'__STATIC__'	=>	__ROOT__.'/public/App/'.GROUP_NAME,
        );
